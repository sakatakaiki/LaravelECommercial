                                    ...
                                    <tr class="cart__row border-bottom line1 cart-flex border-top">
                                            ...
                                            <div class="cart__qty text-center">
                                                <div class="qtyField">
                                                    <form action="{{ route('cart.update') }}" method="POST">
                                                        ...
                                                        <input class="cart__qty-input qty" type="number" name="quantity"
                                        ...
                                        <td class="text-center small--hide">
                                            <form action="{{ route('cart.remove', $orderItem->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn--secondary cart__remove"
                                                    title="Remove item"><i class="icon icon anm anm-times-l"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
                        ...
                        <div id="shipping-calculator" class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 actionRow text-center">
                                    <div><input type="button" class="btn btn--secondary get-rates"
