                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout-1.html" class="grid-view-item__link">
                                    ...
                                    <img class="primary blur-up lazyload"
                                        data-src="{{ asset('images/product-images/product-image1.jpg') }}"
                                        src="{{ asset('images/product-images/product-image1.jpg') }}" alt="image"
                                        title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload"
                                        data-src="{{ asset('images/product-images/product-image1-1.jpg') }}"
                                        src="{{ asset('images/product-images/product-image1-1.jpg') }}" alt="image"
                                        title="product">
                                    <!-- End hover image -->
                                    <!-- Variant Image-->
                            ...
                            <div class="product-details text-center">
                                ...
                                <ul class="swatches">
                                    <li class="swatch small rounded navy"
                                        rel="{{ asset('images/product-images/product-image-stw1.jpg') }}"></li>
                                    <li class="swatch small rounded green"
                                        rel="{{ asset('images/product-images/product-image-stw1-1.jpg') }}"></li>
                                    <li class="swatch small rounded gray"
                                        rel="{{ asset('images/product-images/product-image-stw1-2.jpg') }}"></li>
                                    <li class="swatch small rounded aqua"
                                        rel="{{ asset('images/product-images/product-image-stw1-3.jpg') }}"></li>
                                    <li class="swatch small rounded orange"
                                        rel="{{ asset('images/product-images/product-image-stw1-4.jpg') }}"></li>
                                </ul>
                                <!-- End Variant -->
                            </div>
                            <!-- End product details -->
                        ...
                        <div class="col-6 col-sm-2 col-md-3 col-lg-3 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout-1.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload"
                                        data-src="{{ asset('images/product-images/product-image2.jpg') }}"
                                        src="{{ asset('images/product-images/product-image2.jpg') }}" alt="image"
                                        title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload"
                                        data-src="{{ asset('images/product-images/product-image2-1.jpg') }}"
                                        src="{{ asset('images/product-images/product-image2-1.jpg') }}" alt="image"
                                        title="product">
                                    <!-- End hover image -->
                                    <!-- Variant Image-->
                                    <img class="grid-view-item__image hover variantImg"
                            ...
                            <div class="product-details text-center">
                                ...
                                <ul class="swatches">
                                    <li class="swatch small rounded black"
                                        rel="{{ asset('images/product-images/product-image2.jpg') }}"></li>
                                    <li class="swatch small rounded navy"
                                        rel="{{ asset('images/product-images/product-image-swt2.jpg') }}"></li>
                                    <li class="swatch small rounded purple"
                                        rel="{{ asset('images/product-images/product-image-swt2-1.jpg') }}"></li>
                                    <li class="swatch small rounded teal"
                                        rel="{{ asset('images/product-images/product-image-swt2-2.jpg') }}"></li>
                                </ul>
                                <!-- End Variant -->
                            </div>
                            <!-- End product details -->
                        ...
                        <div class="col-6 col-sm-2 col-md-3 col-lg-3 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout-1.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload"
                                        data-src="{{ asset('images/product-images/product-image3.jpg') }}"
                                        src="{{ asset('images/product-images/product-image3.jpg') }}" alt="image"
                                        title="product">
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload"
                                        data-src="{{ asset('images/product-images/product-image3-1.jpg') }}"
                                        src="{{ asset('images/product-images/product-image3-1.jpg') }}" alt="image"
                                        title="product">
                                    <!-- End hover image -->
                                    <!-- Variant Image-->
                                    <img class="grid-view-item__image hover variantImg"
                            ...
                            <div class="product-details text-center">
                                ...
                                <ul class="swatches">
                                    <li class="swatch small rounded gray"
                                        rel="{{ asset('images/product-images/product-image16.jpg') }}"></li>
                                    <li class="swatch small rounded red"
                                        rel="{{ asset('images/product-images/product-image5.jpg') }}"></li>
                                    <li class="swatch small rounded orange"
                                        rel="{{ asset('images/product-images/product-image5-1.jpg') }}"></li>
                                    <li class="swatch small rounded yellow"
                                        rel="{{ asset('images/product-images/product-image17.jpg') }}"></li>
                                </ul>
                                <!-- End Variant -->
                            </div>
                            <!-- End product details -->
                        ...
                        <div class="col-6 col-sm-2 col-md-3 col-lg-3 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout-1.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload"
                                        data-src="{{ asset('images/product-images/product-image4.jpg') }}"
                                        src="{{ asset('images/product-images/product-image4.jpg') }}" alt="image"
                                        title="product" />
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload"
                                        data-src="{{ asset('images/product-images/product-image4-1.jpg') }}"
                                        src="{{ asset('images/product-images/product-image4-1.jpg') }}" alt="image"
                                        title="product" />
                                    <!-- End hover image -->
                                    <!-- Variant Image-->
                                    <img class="grid-view-item__image hover variantImg"
                            ...
                            <div class="product-details text-center">
                                ...
                                <ul class="swatches">
                                    <li class="swatch small rounded black"
                                        rel="{{ asset('images/product-images/cape-dress-2.jpg') }}"></li>
                                    <li class="swatch small rounded maroon"
                                        rel="{{ asset('images/product-images/product-image4-1.jpg') }}"></li>
                                    <li class="swatch small rounded navy"
                                        rel="{{ asset('images/product-images/product-image2.jpg') }}"></li>
                                    <li class="swatch small rounded darkgreen"
                                        rel="{{ asset('images/product-images/product-image2-1.jpg') }}"></li>
                                </ul>
                                <!-- End Variant -->
                            </div>
                            <!-- End product details -->
                        ...
                        <div class="col-6 col-sm-2 col-md-3 col-lg-3 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout-1.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload"
                                        data-src="{{ asset('images/product-images/product-image5.jpg') }}"
                                        src="{{ asset('images/product-images/product-image5.jpg') }}" alt="image"
                                        title="product" />
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload"
                                        data-src="{{ asset('images/product-images/product-image5-1.jpg') }}"
                                        src="{{ asset('images/product-images/product-image5-1.jpg') }}" alt="image"
                                        title="product" />
                                    <!-- End hover image -->
                                    <!-- Variant Image-->
                                    <img class="grid-view-item__image hover variantImg"
                        ...
                        <div class="col-6 col-sm-2 col-md-3 col-lg-3 item">
                            <div class="product-image">
                                ...
                                <a href="product-layout-1.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload"
                                        data-src="{{ asset('images/product-images/product-image19.jpg') }}"
                                        src="{{ asset('images/product-images/product-image19.jpg') }}" alt="image"
                                        title="product" />
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload"
                                        data-src="{{ asset('images/product-images/product-image19-1.jpg') }}"
                                        src="{{ asset('images/product-images/product-image19-1.jpg') }}" alt="image"
                                        title="product" />
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                        ...
                        <div class="col-6 col-sm-2 col-md-3 col-lg-3 item">
                            <div class="product-image">
                                ...
                                <a href="product-layout-1.html" class="grid-view-item__link">
                                    <!-- image -->
                                    <img class="primary blur-up lazyload"
                                        data-src="{{ asset('images/product-images/product-image18.jpg') }}"
                                        src="{{ asset('images/product-images/product-image18.jpg') }}" alt="image"
                                        title="product" />
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload"
                                        data-src="{{ asset('images/product-images/product-image18-1.jpg') }}"
                                        src="{{ asset('images/product-images/product-image18-1.jpg') }}" alt="image"
                                        title="product" />
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
