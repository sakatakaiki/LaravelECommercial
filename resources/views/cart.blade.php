...
@section('content')
    ...
    <div id="page-content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-8 col-lg-8 main-col cart style2">
                    ...
                    <table>
                            ...
                            @foreach ($cart as $orderItem)
                                <tr class="cart__row border-bottom line1 cart-flex border-top">
                                    <td class="cart__image-wrapper cart-flex-item">
                                        <img class="cart__image" src="{{ $orderItem->product->thumbnail }}"
                                    ...
                                    <td class="cart__price-wrapper cart-flex-item">
                                        <span class="money"
                                            data-usd-price="{{ number_format($orderItem->price, 2) }}">${{ number_format($orderItem->price, 2) }}</span>
                                    </td>
                                    <td class="cart__update-wrapper cart-flex-item text-right">
                                        <div class="cart__qty text-center">
                                            <div class="qtyField">
                                                <a class="qtyBtn minus"
                                                    href="{{ route('cart.updateQuantity', ['itemId' => $orderItem->id, 'action' => 'decrease']) }}">
                                                    <i class="icon icon-minus"></i>
                                                </a>
                                                <input class="cart__qty-input qty" type="text" name="updates[]" id="qty"
                                                    value="{{ $orderItem->quantity }}" pattern="[0-9]*">
                                                <a class="qtyBtn plus"
                                                    href="{{ route('cart.updateQuantity', ['itemId' => $orderItem->id, 'action' => 'increase']) }}">
                                    ...
                                    <td class="text-right small--hide cart-price">
                                        <div><span
                                                class="money">${{ number_format($orderItem->price * $orderItem->quantity, 2) }}</span>
                                        </div>
                                    </td>
                                    <td class="text-center small--hide">
                                        <form action="{{ route('cart.remove', $orderItem->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn--secondary cart__remove" title="Remove item"><i
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="3" class="text-left"><a href="{{ route('home') }}"
                    ...
                    <div class="currencymsg">We processes all orders in USD. While the content of your cart is currently
                        displayed in VND, the checkout will use USD at the most current exchange rate.</div>
                    <hr>
                    <div id="shipping-calculator" class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <select id="address_country" name="address[country]" data-default="United States">
                                        ...
                                        <option value="Bonaire, Sint Eustatius and Saba" data-provinces="[]">Caribbean
                                            Netherlands</option>
                                        ...
                                        <option value="Congo, The Democratic Republic Of The" data-provinces="[]">Congo
                                            - Kinshasa</option>
                                        ...
                                        <option value="French Southern Territories" data-provinces="[]">French Southern
                                            Territories</option>
                                        ...
                                        <option value="Svalbard And Jan Mayen" data-provinces="[]">Svalbard &amp; Jan
                                            Mayen</option>
                                        ...
                                        <option value="Turks and Caicos Islands" data-provinces="[]">Turks &amp; Caicos
                                            Islands</option>
                                        <option value="Tuvalu" data-provinces="[]">Tuvalu</option>
                                        <option value="United States Minor Outlying Islands" data-provinces="[]">U.S.
                            ...
                            <div class="col-12 col-sm-12 col-md-12 actionRow text-center">
                                <div><input type="button" class="btn btn--secondary get-rates" value="Calculate shipping">
                                </div>
                            </div>
                        </div>
                    </div>
