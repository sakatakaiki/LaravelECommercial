                                    ...
                                    <li class="grid__item large-up--one-whole">
                                        <ul class="grid">
                                            <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#"
                                                ...
                                                <ul class="subLinks">
                                                    <li class="lvl-2"><a href="{{ route('home') }}"
                                                            class="site-nav lvl-2">Home 1
                                                            - Classic</a></li>
                        ...
                        <li class="lvl1 parent megamenu"><a href="#">Shop <i class="anm anm-angle-down-l"></i></a>
                            <div class="megamenu style4">
                                <ul class="grid grid--uniform mmWrapper">
                                    <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#"
                                            class="site-nav lvl-1">Categories</a>
                                        <ul class="subLinks">
                                            @foreach($categories as $category)
                                                <li class="lvl-2"><a href="{{ route('categories', $category->id) }}"
                                                        class="site-nav lvl-2">{{ $category->name }}</a></li>
                                            @endforeach
                                        </ul>
                                    </li>
                                    <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#"
                                            class="site-nav lvl-1">Category Features</a>
                                        <ul class="subLinks">
                                            @foreach($topCategories as $category)
                                                <li class="lvl-2"><a href="{{ route('categories', $category->id) }}"
                                                        class="site-nav lvl-2">{{ $category->name }} <span
                                                            class="lbl nm_label3">Hot</span></a></li>
                                            @endforeach
                                        </ul>
                                    </li>
                                    <li class="grid__item lvl-1 col-md-6 col-lg-6">
                                        <a href="#"><img src="{{ asset('images/megamenu-bg1.jpg') }}" alt=""
                                                title="" /></a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="megamenu style2">
                                <ul class="grid mmWrapper">
                                    ...
                                    <li class="grid__item large-up--one-whole imageCol"><a href="#"><img
                                                src="{{ asset('images/megamenu-bg2.jpg') }}" alt=""></a></li>
                                </ul>
                            </div>
                        </li>
            ...
            <div class="col-4 col-sm-3 col-md-3 col-lg-2">
                <div class="site-cart">
                    ...
                    <div id="header-cart" class="block block-cart">
                        <ul class="mini-products-list" id="miniCartItems">
                            <li class="item">Loading...</li>
                            <!-- <li class="item">
                                <a class="product-image" href="#">
                                    <img src="{{ asset('images/product-images/cape-dress-1.jpg') }}"
                        ...
                        <div class="total">
                            <div class="total-in">
                                ...
                                id="cartSubtotal" class="money">$0.00</span></span>
                            </div>
                            <div class="buttonSet text-center">
                                <a href="{{ route('cart.view') }}" class="btn btn-secondary btn--small">View Cart</a>
